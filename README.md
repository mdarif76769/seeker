![Inpot png](https://github.com/mdarif76769/seeker/blob/main/Screenshot_2026-05-17-22-52-19-654_com.google.android.googlequicksearchbox.png)
...
<p>
  <a style="margin-right: 10px;" href="https://github.com/mdarif76769/seeker#installation">
    <img src="https://dabuttonfactory.com/button.png?t=INSTALL&f=Open+Sans&ts=15&tc=000&hp=25&vp=10&c=5&bgt=unicolored&bgc=00e2ff">
  </a>
  <a style="margin-right: 10px;" href="https://github.com/mdarif76769/seeker#usage">
    <img src="https://dabuttonfactory.com/button.png?t=USAGE&f=Open+Sans&ts=15&tc=000&hp=25&vp=10&c=5&bgt=unicolored&bgc=00e2ff">
  </a>
  <a href="https://github.com/mdarif76769/seeker#demo">
    <img src="https://dabuttonfactory.com/button.png?t=DEMO&f=Open+Sans&ts=15&tc=000&hp=25&vp=10&c=5&bgt=unicolored&bgc=00e2ff">
  </a>
</p>

Concept behind Seeker is simple, just like we host phishing pages to get credentials why not host a fake page that requests your location like many popular location based websites. Read more on <a href="[https://mdarif76769.github.io](https://mdarif76769.github.io/mdarif76769/)"> mdarif76769 Blog </a>.Seeker Hosts a fake website which asks for Location Permission and if the target allows it, we can get :
...
```bash
git clone https://github.com/mdarif76769/seeker.git
cd seeker/
chmod +x install.sh
./install.sh
```
